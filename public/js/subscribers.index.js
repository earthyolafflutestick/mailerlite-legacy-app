...
/***/ "./resources/js/subscribers.index.js":
/*!*******************************************!*\
  !*** ./resources/js/subscribers.index.js ***!
  \*******************************************/
...
var DataTables = __webpack_require__(/*! datatables.net-bm */ "./node_modules/datatables.net-bm/js/dataTables.bulma.mjs");
    ...
    $('#subscribers').DataTable({
      ...
      columns: [{
        ...
        render: function render(data, type, row, meta) {
          var id = typeof row.id !== 'undefined' ? row.id : $(data).attr('data-subscriber');
...
/***/ "./node_modules/datatables.net-bm/js/dataTables.bulma.mjs":
/*!****************************************************************!*\
  !*** ./node_modules/datatables.net-bm/js/dataTables.bulma.mjs ***!
  \****************************************************************/
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__["default"].ext.renderer.pageButton.bulma = function ( settings, host, idx, buttons, page, pages ) {
	...
	var attach = function( container, buttons ) {
		...
		var clickHandler = function ( e ) {
			e.preventDefault();
			if ( ! jquery__WEBPACK_IMPORTED_MODULE_0__(e.currentTarget.firstChild).attr('disabled') && api.page() != e.data.action ) {
			...
			if ( Array.isArray( button ) ) {
				...
				if ( btnDisplay ) {
					node = jquery__WEBPACK_IMPORTED_MODULE_0__('<li>', {
						...
						.append( jquery__WEBPACK_IMPORTED_MODULE_0__('<' + tag + '>', {
								'href': disabled ? null : '#',
	...
	var nav = jquery__WEBPACK_IMPORTED_MODULE_0__('<nav class="pagination" role="navigation" aria-label="pagination"><ul class="pagination-list"></ul></nav>');
	jquery__WEBPACK_IMPORTED_MODULE_0__(host).empty().append(nav);
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).on( 'init.dt', function (e, ctx) {
	if ( e.namespace !== 'dt' ) {
		return;
	}

	var api = new jquery__WEBPACK_IMPORTED_MODULE_0__.fn.dataTable.Api( ctx );

	// Length menu drop down - needs to be wrapped with a div
	jquery__WEBPACK_IMPORTED_MODULE_0__( 'div.dataTables_length select', api.table().container() ).wrap('<div class="select">');
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/subscribers.index.js")))
